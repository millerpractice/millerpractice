                ...
                <Paper square={true} style={{ backgroundColor: lightGreen[100], height: 650, overflowX: "hidden", overflowY: "hidden" }}>
                    <Grid container >
                        ...
                        <Grid item xs>
                            ...
                            <img src={healthcare} alt="healthcare" style={{ float: "right", marginTop: 50, height: 200, marginRight: 230 }} />
                            <img src={hearth} alt="hearth" style={{ float: "right", marginTop: 170, height: 200, marginRight: 180 }} />
                        </Grid>
                    </Grid>
                </Paper>
            </ScrollableAnchor>
